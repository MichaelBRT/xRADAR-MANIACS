function [init_arc, tau, thrust, deltaV_req,td, thrust_arc] = get_initial_arc(C,orbit1_name,orbit2_name,mu)
...
ind_i = utils.findClosestJacobi(i_data,C);
ind_f = utils.findClosestJacobi(f_data,C);
